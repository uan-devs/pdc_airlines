...
<main class="h-100 pb-16 overflow-y-auto">
    <div class="container grid px-0 mx-auto h-100">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 ">
            Papeis e Permissões de {{$user->name}}
        </h2>
       ...
       <!-- TABELA  -->
        <div class="w-100 h-100 d-block shadow-xs bg-white rounded p-4 ">
            <div class="d-flex justify-content-between align-items mb-3">
                ...
                <div class=" ">
                  <a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#modalNovaPermissao">Novo Papel</a>
                </div>    
            </div>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td scope="row">{{$item->permissao}}</td>
                    <td class="d-flex align-items-center">
                      <!-- <a href="{{route('papeis.permissoes',$item->id_permissao)}}" class="mr-5 btn btn-primary btn-sm">
                        Ver permissões
                      </a> -->
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Atribuir Novo Papel</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form method="post" action="{{route('papeis.atribuir')}}">
                            @csrf
                          ...
                          <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <select name="id_papel" id="" class="form-control">
                                    @foreach($outrosPapeis as $item)
                                        <option value="{{$item->id_papel}}">{{$item->papel}}</option>
                                    @endforeach
                                </select>
                                </div>
                          </div>
