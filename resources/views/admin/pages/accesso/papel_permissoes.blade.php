                      ...
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Atribuir Nova Permissão</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <form method="post" action="{{route('permissoes.atribuir')}}">
                            @csrf
                            <input type="hidden" name="id_papel" value="{{$papel->id}}">
                          <div class="modal-body">
                            
                              <div class="form-group">
                                <label for="recipient-name" class="col-form-label">Permissão:</label>
                                <select name="id_permissao" id="" class="form-control">
                                    @foreach($outrasPermissoes as $item)
