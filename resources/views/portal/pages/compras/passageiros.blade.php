                            ...
                            <div class="w-100 bg-white rounded-lg shadow-lg p-3 mb-2">
                                ...
                                <div class="form-row px-4">
                                    <div class="form-group form-check col-12 col-md-1">
                                        ...
                                        <input  class="form-check-input" type="radio" 
                                                ...
                                                value="sr" @if($i==1) checked  @endif class="form-control">
                                          Sr
                                        </label>
                                    </div>
                                    <div class="form-group form-check col-12 col-md-1">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-5">
                                        ...
                                        <input class="form-control" type="text" name="nome{{$i}}" id="" 
                                        placeholder="Nome do Passageiro" value="{{$i==1?session('membro')->nome:''}}">
                                    </div>
                                    <div class="form-group col-12 col-md-5">
                                        <label for="sobrenome">Sobrenome</label>
                                        <input class="form-control" type="text" name="sobrenome{{$i}}"
                                        placeholder="Sobrenome do Passageiro" value="{{$i==1?session('membro')->sobrenome:''}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-5">
                                        <label for="email{{$i}}">Email</label>
                                        <input class="form-control" type="email" name="email{{$i}}" 
                                        id="" placeholder="Email do Passageiro" value="{{$i==1?session('membro')->email:''}}">
                                    </div>
                                    <div class="form-group col-12 col-md-5">
                                        <label for="telefone">Telefone</label>
                                        <input class="form-control" type="text" name="telefone{{$i}}" id="" 
                                        placeholder="Telefone do Passageiro" value="{{$i==1?session('membro')->telefone:''}}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-12 col-md-5">
                                        <label for="data">Data de Nascimento</label>
                                        <input class="form-control" type="date" name="data{{$i}}" id="" 
                                        placeholder="Data de nascimento do Passageiro" value="{{$i==1?session('membro')->data:''}}">
                                    </div>
                                </div>
                            </div>
                        @endfor
